...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢', url="https://t.me/FilesUlagam0")
            ],[
            InlineKeyboardButton('ℹ️ 𝙷𝙴𝙻𝙿 ℹ️', url="https://t.me/FilesUlagam0")
            ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("💫 𝙶𝚁𝙾𝚄𝙿 💫", url="https://t.me/+BBhMHZ2Xh7M5ZDY1")
        ]]
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton("🔍 𝚂𝙴𝙰𝚁𝙲𝙷 🔍", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/FilesUlagam")
            ],[      
            InlineKeyboardButton("ℹ️ 𝙷𝙴𝙻𝙿 ℹ️", callback_data="help"),
            InlineKeyboardButton("💫 𝙶𝚁𝙾𝚄𝙿 💫", url="https://t.me/+BBhMHZ2Xh7M5ZDY1")
        ]]
